...
<a href="inhoadon.php?id=<?= $r['maDonHang'] ?>">🖨 In hóa đơn</a>
    <?php if ($r['trangThai'] == 0): ?>
        | <a href="update_order_status.php?id=<?= $r['maDonHang'] ?>&status=1">
            🚚 Xác nhận giao hàng
        </a>
    <?php endif; ?>

    <?php if ($r['trangThai'] == 1): ?>
        | <a href="update_order_status.php?id=<?= $r['maDonHang'] ?>&status=2">
            ✅ Hoàn thành đơn
        </a>
    <?php endif; ?>
</td>
    ...
    <a class="back-link" href="./admin/index.php">⬅ Quay lại</a>
</div>
</body>
</html>
