...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <hr class="sidebar-divider d-none d-md-block">
        <li class="nav-item"><a class="nav-link load-page" data-page="qldanhmuc.php" href="#"><i class="fas fa-list"></i><span>Quản lý Danh Mục</span></a></li>
        <hr class="sidebar-divider">
<?php if ($vaitro === 'admin'): ?>
<li class="nav-item">
    <a class="nav-link load-page" href="#" data-page="manage_events.php">
        <i class="fas fa-fw fa-bolt"></i>
        <span>Flash Sale / Sự kiện</span>
    </a>
</li>
<?php endif; ?>

<?php if ($vaitro === 'seller'): ?>
<li class="nav-item">
    <a class="nav-link load-page" href="#" data-page="my_discounts.php">
        <i class="fas fa-fw fa-tags"></i>
        <span>Giảm giá của tôi</span>
    </a>
</li>
<?php endif; ?>
    </a>
